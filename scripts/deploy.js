...
async function main() {
  ...
  const greeter = await Greeter.deploy(nft.address,xgrav.address,grav.address);
  ...
  console.log("\x1b[1m","Transferring 1000 Grav from user wallet to Voyager contract");
